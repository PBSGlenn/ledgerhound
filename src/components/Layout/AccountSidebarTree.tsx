...
export function AccountSidebarTree({
  ...
  return (
    ...
    >
      ...
      {/* Tabs */}
      {!collapsed && (
        <div className="px-2 pt-2 border-b border-slate-200 dark:border-slate-700">
          <div className="flex gap-2 pb-3">
            <button
              onClick={() => setActiveTab('real')}
              className={`flex-1 px-2 py-1 rounded-lg text-sm font-medium transition-all duration-150 flex items-center justify-center gap-2 ${
                activeTab === 'real'
        ...
        {!collapsed && (
          <>
            <button
              ...
              className="w-full px-3 py-1.5 bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-white rounded-lg text-sm font-medium shadow-sm hover:shadow transition-all duration-150 flex items-center justify-center gap-2"
            >
            ...
            <button
              onClick={onRefresh}
              className="w-full px-3 py-1.5 bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white rounded-lg text-sm font-medium shadow-sm hover:shadow transition-all duration-150 flex items-center justify-center gap-2"
            >
