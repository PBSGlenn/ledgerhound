...
INSERT INTO "new_accounts" ("archived", "created_at", "currency", "id", "is_business_default", "is_real", "kind", "name", "opening_balance", "opening_date", "sort_order", "subtype", "type", "updated_at") SELECT "archived", "created_at", "currency", "id", "is_business_default", "is_real", "kind", "name", "opening_balance", "opening_date", "sort_order", "subtype", "type", "updated_at" FROM "accounts";
DROP TABLE "accounts";
